...
plot(all_peaks(is_hot_spot), 10 * log10(x(all_peaks(is_hot_spot), 1) .^ 2) - pad.hot_spot_attenuation_db, 'c*', "markersize", 15);
...
if was_peak_found && ...
  ...
  is_hot_spot_debug = [is_hot_spot_debug; stored_is_hotspot]; % just for debugging
