...
const float ADC_noise_peak_velocity_scaling = 1.0f / 6.0f;
      ...
      bool         hot_spot_is_used;
      int          second_peak_diff;
      int          hot_spot_sec_peak_half_win_len;
      int          hot_spot_hist_len;
      float        hot_spot_peak_diff_limit_min;
      float        hot_spot_middle_diff;
      int          hot_spot_cnt;
      int          hot_spot_hist_idx;
      int          lp_filt_len;
      int          x_low_hist_len;
      int          x_low_hist_idx;
      int          pos_sense_cnt;
