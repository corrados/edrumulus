...
if [[ -v is_teensy ]]; then
  ...
  if [[ -v is_settings ]]; then
    # general settings
    echo -e '\xB9\x6E\x04' > /dev/ttyUSB0 # spike cancellation: 4
    ...
    echo -e '\xB9\x69\x16' > /dev/ttyUSB0 # pos threshold:    22
    echo -e '\xB9\x6A\x1F' > /dev/ttyUSB0 # pos sensitivity:  31
    echo -e '\xB9\x6F\x03' > /dev/ttyUSB0 # rim/pos:          3 (both)
    echo -e '\xB9\x70\x26' > /dev/ttyUSB0 # midi note:        38
    echo -e '\xB9\x71\x28' > /dev/ttyUSB0 # midi note rim:    40
    echo -e '\xB9\x72\x05' > /dev/ttyUSB0 # crosstalk cancel: 5
    ...
    echo -e '\xB9\x70\x24' > /dev/ttyUSB0 # midi note:        36
    echo -e '\xB9\x72\x00' > /dev/ttyUSB0 # crosstalk cancel: 0
    ...
    echo -e '\xB9\x6F\x00' > /dev/ttyUSB0 # rim/pos:          0 (none)
    echo -e '\xB9\x70\x16' > /dev/ttyUSB0 # midi note:        22
    echo -e '\xB9\x72\x08' > /dev/ttyUSB0 # crosstalk cancel: 8

    # Hi-Hat control
    echo -e '\xB9\x6C\x03' > /dev/ttyUSB0 # select pad:       3
    echo -e '\xB9\x66\x03' > /dev/ttyUSB0 # pad type:         FD8
    echo -e '\xB9\x67\x0C' > /dev/ttyUSB0 # threshold:        12
    echo -e '\xB9\x68\x1F' > /dev/ttyUSB0 # sensitivity:      31
    echo -e '\xB9\x70\x2C' > /dev/ttyUSB0 # midi note:        44
    ...
    echo -e '\xB9\x68\x09' > /dev/ttyUSB0 # sensitivity:      9
    echo -e '\xB9\x6F\x00' > /dev/ttyUSB0 # rim/pos:          0 (none)
    echo -e '\xB9\x70\x31' > /dev/ttyUSB0 # midi note:        49
    echo -e '\xB9\x72\x08' > /dev/ttyUSB0 # crosstalk cancel: 8
    ...
    echo -e '\xB9\x68\x06' > /dev/ttyUSB0 # sensitivity:      6
    echo -e '\xB9\x6F\x00' > /dev/ttyUSB0 # rim/pos:          0 (none)
    echo -e '\xB9\x70\x30' > /dev/ttyUSB0 # midi note:        48
    echo -e '\xB9\x72\x04' > /dev/ttyUSB0 # crosstalk cancel: 4
    ...
    echo -e '\xB9\x68\x09' > /dev/ttyUSB0 # sensitivity:      9
    echo -e '\xB9\x6F\x00' > /dev/ttyUSB0 # rim/pos:          0 (none)
    echo -e '\xB9\x70\x33' > /dev/ttyUSB0 # midi note:        51
    echo -e '\xB9\x72\x00' > /dev/ttyUSB0 # crosstalk cancel: 0
    ...
    echo -e '\xB9\x68\x06' > /dev/ttyUSB0 # sensitivity:      6
    echo -e '\xB9\x6F\x00' > /dev/ttyUSB0 # rim/pos:          0 (none)
    echo -e '\xB9\x70\x2D' > /dev/ttyUSB0 # midi note:        45
    echo -e '\xB9\x72\x04' > /dev/ttyUSB0 # crosstalk cancel: 4
    ...
    echo -e '\xB9\x68\x06' > /dev/ttyUSB0 # sensitivity:      6
    echo -e '\xB9\x6F\x00' > /dev/ttyUSB0 # rim/pos:          0 (none)
    echo -e '\xB9\x70\x2B' > /dev/ttyUSB0 # midi note:        43
    echo -e '\xB9\x72\x04' > /dev/ttyUSB0 # crosstalk cancel: 4
  fi
