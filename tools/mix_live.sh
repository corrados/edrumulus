...
-a:KDrum -i jack_multi,DrumGizmo:0-KDrum \
     -elv2:urn:ardour:a-comp,22,70,0,7,-27,4.3,0,1 \
     -elv2:urn:ardour:a-eq,160,0,65,10.9,1.230,6147,12.6,1.2,256,-15.7,0.766,909,-9.3,0.622,8088,-7.4,4.33,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:50 \
     -elv2:urn:ardour:a-reverb,0.2,1,0 \
-a:Snare -i jack_multi,DrumGizmo:1-Snare \
     -elv2:urn:ardour:a-comp,10,80,0,4,-30,0 \
     -elv2:urn:ardour:a-eq,28,-20,86,3.1,1,194,-4.9,0.38,2500,0,1,660,-3.5,0.32,1947,1.9,3.5,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:50 \
     -elv2:urn:ardour:a-reverb,0.3,0.5,1 \
-a:Hihat -i jack_multi,DrumGizmo:2-Hihat \
     -elv2:urn:ardour:a-comp,10,80,0,4,-30,0 \
     -elv2:urn:ardour:a-eq,315,-20,300,0,1,1000,0,1,2500,0,1,6000,0,1,9664,18.6,-14.227,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:30 \
     -elv2:urn:ardour:a-reverb,0.2,1,0 \
-a:Tom1 -i jack_multi,DrumGizmo:3-Tom1 \
     -elv2:urn:ardour:a-comp,10,80,0,4,-30,0 \
     -elv2:urn:ardour:a-eq,160,0,300,0,1,106,11.5,0.9,829,-3.1,2.26,5204,13.6,1,9000,0,-4.35,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:40 \
     -elv2:urn:ardour:a-reverb,0.2,1,0 \
-a:Tom2 -i jack_multi,DrumGizmo:4-Tom2 \
     -elv2:urn:ardour:a-comp,10,80,0,4,-30,0 \
     -elv2:urn:ardour:a-eq,160,0,251,0,1,95,10.5,1.12,829,0,2.26,4676,13,1.08,9000,0,-6.2,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:60 \
     -elv2:urn:ardour:a-reverb,0.2,1,0 \
-a:Tom3 -i jack_multi,DrumGizmo:5-Tom3 \
     -elv2:urn:ardour:a-comp,10,80,0,4,-30,0 \
     -elv2:urn:ardour:a-eq,160,0,300,0,1,86,11.5,1.04,829,-3.5,2.26,4355,14.6,1.55,9000,0,-4.97,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:70 \
     -elv2:urn:ardour:a-reverb,0.2,1,0 \
-a:OHLeft -i jack_multi,DrumGizmo:6-OHLeft \
     -elv2:urn:ardour:a-comp,10,80,0,4,-30,0 \
     -elv2:urn:ardour:a-eq,160,0,300,0,1,100,0,1,2500,0,1,6000,0,1,3321,6,-12,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:0 \
     -elv2:urn:ardour:a-reverb,0.2,1,0 \
-a:OHRight -i jack_multi,DrumGizmo:7-OHRight \
     -elv2:urn:ardour:a-comp,10,80,0,4,-30,0 \
     -elv2:urn:ardour:a-eq,160,0,300,0,1,100,0,1,2500,0,1,6000,0,1,3321,6,-12,1,1,1,1,1,1,1 \
     -chcopy:1,2 -ea:800 -epp:100 \
     -elv2:urn:ardour:a-reverb,0.2,1,0 \
-a:all -o jack,system
