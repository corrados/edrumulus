...
% kit and optional instrument select (only process this instrument)
kit_select        = 3;
...
if 1
channel_properties{1} = {'AmbL',         'AmbL',          -2, -90,   0,  10000,  0.5,   0,  10000, 0.5; ...
...
channel_properties{1} = {'AmbL',         'AmbL',         -90, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
...
midi_map{1} = {'Crash_left_shank',   {55, 49}; ...
...
if 1
channel_properties{2} = {'Alesis',        'Trigger',       -90, -90,   0,  10000,  0.5,   0,  10000, 0.5; ...
...
if 1
channel_properties{3} = {'AmbLeft',      'AmbLeft',        3, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
...
channel_properties{3} = {'AmbLeft',      'AmbLeft',      -90, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
...
% use properties of select kit
kit_path           = kit_path{kit_select};
channel_properties = channel_properties{kit_select};
midi_map           = midi_map{kit_select};
