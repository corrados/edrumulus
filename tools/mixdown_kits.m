...
channel_properties = {'AmbL',         'AmbL',          -2, -90,   0, 0, 0; ...
                      'AmbR',         'AmbR',         -90,  -2,   0, 0, 0; ...
                      'Hihat',        'Hihat',         -3,  -3,   0, 0, 0; ...
                      'Kdrum_back',   'Kdrum_back',    -4,  -4,   6, 0, 0; ...
                      'Kdrum_front',  'Kdrum_front',   -4,  -4,   0, 0, 6; ...
                      'OHL',          'OHL',           -3, -90,   0, 0, 0; ...
                      'OHR',          'OHR',          -90,  -3,   0, 0, 0; ...
                      'Ride',         'Ride',          -2,  -2,   0, 0, 3; ...
                      'Snare_bottom', 'Snare_bottom',  -8,  -8,   0, 0, 0; ...
                      'Snare_top',    'Snare_top',     -9,  -9,   4, 0, 0; ...
                      'Tom1',         'Tom1',          -2,  -2,   0, 0, 3; ...
                      'Tom2',         'Tom2',          -4,  -4,   2, 0, 0; ...
                      'Tom3',         'Tom3',          -2,  -2,   0, 0, 0};
...
kit_path           = 'CrocellKit/';
channel_properties = {'AmbLeft',      'AmbLeft',       -6, -90,   0,  0, 0; ...
                      'AmbRight',     'AmbRight',     -90,  -6,   0,  0, 0; ...
                      'FTom1',        'FTom1',          0,   0,   0,  0, 0; ...
                      'FTom2',        'FTom2',          0,   0,   0,  0, 0; ...
                      'Hihat',        'Hihat',          0,   0,  -9, -5, 1; ...
                      'KDrumInside',  'KDrumInside',    0,   0,   2, -5, 5; ...
                      'KDrumOutside', 'KDrumOutside',  -3,  -3,   8, -5, 5; ...
                      'OHCenter',     'OHCenter',      -5,  -5,  -9, -5, 1; ...
                      'OHLeft',       'OHLeft',        -3, -90,  -9, -5, 1; ...
                      'OHRight',      'OHRight',      -90,  -3,  -9, -5, 1; ...
                      'Ride',         'Ride',           0,   0,  -9, -2, 0; ...
                      'SnareBottom',  'SnareBottom',    0,   0,   2, -1, 5; ...
                      'SnareTop',     'SnareTop',       0,   0,   2,  0, 0; ...
                      'Tom1',         'Tom1',           0,   0,   0,  0, 0; ...
                      'Tom2',         'Tom2',           0,   0,   0,  0, 0};
midi_map           = {'CrashL',       55; ...
                      'HihatClosed',  22; ...
    ...
    for sample_index = 1:length(instr_samples_dir)
      ...
      if ~instr_samples_dir(sample_index).isdir
        ...
        for channel_index = 1:size(x_all, 2)
          ...
          if eq_mid ~= 0
            if eq_mid > 0
              [b, a] = butter(3, [1000, 3000] / sampling_rate * 2);
            else
              [b, a] = butter(3, [1000, 3000] / sampling_rate * 2, 'stop');
            end
          ...
          if eq_high ~= 0
            if eq_high > 0
              [b, a] = butter(3, [5000, 15000] / sampling_rate * 2);
            else
              [b, a] = butter(3, [5000, 15000] / sampling_rate * 2, 'stop');
            end
