...
channel_properties = {'AmbL',         'AmbL',          -2, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      ...
                      'Kdrum_back',   'Kdrum_back',    -4, -4,   10,     75, 0.2, -10,    400, 0.2; ...
                      'Kdrum_front',  'Kdrum_front',   -7, -7,    5,   6000, 0.4,   0,  10000, 0.5; ...
                      ...
                      'Snare_top',    'Snare_top',     -3,  -3,  10,    120, 0.2,   0,  10000, 0.5; ...
...
channel_properties = {'Alesis',        'Trigger',       -90, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Amb L',         'AmbL',           -3, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Amb R',         'AmbR',          -90,  -3,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Hihat',         'Hihat',           0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Kick L',        'KdrumL',          0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Kick R',        'KdrumR',          0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'OH L',          'OHL',            -3, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'OH R',          'OHR',           -90,  -3,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Ride',          'Ride',            0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Snare bottom',  'Snare_bottom',    3,   3,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Snare top',     'Snare_top',       3,   3,   0,  10000, 0.5,   0,  10000, 0.5; ...
...
kit_path           = 'CrocellKit/';
channel_properties = {'AmbLeft',      'AmbLeft',       -6, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'AmbRight',     'AmbRight',     -90,  -6,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'FTom1',        'FTom1',          0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'FTom2',        'FTom2',          0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Hihat',        'Hihat',          0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'KDrumInside',  'KDrumInside',    0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'KDrumOutside', 'KDrumOutside',  -3,  -3,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'OHCenter',     'OHCenter',      -5,  -5,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'OHLeft',       'OHLeft',        -3, -90,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'OHRight',      'OHRight',      -90,  -3,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Ride',         'Ride',           0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'SnareBottom',  'SnareBottom',    0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'SnareTop',     'SnareTop',       0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Tom1',         'Tom1',           0,   0,   0,  10000, 0.5,   0,  10000, 0.5; ...
                      'Tom2',         'Tom2',           0,   0,   0,  10000, 0.5,   0,  10000, 0.5};
midi_map           = {'CrashL',       55; ...
                      'HihatClosed',  22; ...
